      ...
      <article className="space-y-12">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-2 pl-6 text-sm text-muted-foreground">
            ...
            <li>불일치 페어링 — <code className="rounded bg-muted px-1 py-0.5 text-xs">duration-100</code> + <code className="rounded bg-muted px-1 py-0.5 text-xs">ease-emphasized</code> (emphasized 는 slow 와 매칭).</li>
